...
/* themes/custom/dream_agency/templates/fields/field--node--field-hero-image.html.twig */
class __TwigTemplate_8a6d74816ca156cbed71edb80332fee6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            if (($context["multiple"] ?? null)) {
                // line 47
                echo "    <div class=\"slick__controls__arrows\"></div>
    <div";
                // line 48
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "hero-images"], "method", false, false, true, 48), 48, $this->source), "html", null, true);
                echo ">
      ";
                // line 49
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 50
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 50), "addClass", [0 => "hero-image"], "method", false, false, true, 50), 50, $this->source), "html", null, true);
                    echo ">";
      ...
      ";
                ...
                // line 52
                echo "    </div>
    <div class=\"slick__controls__dots\"></div>
  ";
            } else {
                // line 55
                echo "    ";
...
";
    ...
    {
        return "themes/custom/dream_agency/templates/fields/field--node--field-hero-image.html.twig";
    }
    ...
    {
        return array (  137 => 71,  133 => 69,  130 => 68,  119 => 66,  114 => 65,  110 => 63,  108 => 62,  102 => 61,  97 => 60,  93 => 58,  82 => 56,  77 => 55,  72 => 52,  61 => 50,  57 => 49,  53 => 48,  50 => 47,  47 => 46,  45 => 45,  42 => 44,  40 => 41,  39 => 40,);
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div class=\"slick__controls__arrows\"></div>
    <div{{ attributes.addClass(\"hero-images\") }}>
      {% for item in items %}
        <div{{ item.attributes.addClass(\"hero-image\") }}>{{ item.content }}</div>
      {% endfor %}
    </div>
    <div class=\"slick__controls__dots\"></div>
  {% else %}
...
{% endif %}
", "themes/custom/dream_agency/templates/fields/field--node--field-hero-image.html.twig", "/var/www/html/web/themes/custom/dream_agency/templates/fields/field--node--field-hero-image.html.twig");
    }
