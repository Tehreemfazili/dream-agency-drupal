...
class __TwigTemplate_0bc2d6a1a9133c0221e194b62f9964ca extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
        // line 84
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\devel\Twig\Extension\Debug']->message($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 84, $this->source)]));
        echo "
</article>
";
    }
    ...
    {
        return array (  81 => 84,  76 => 82,  71 => 80,  66 => 78,  62 => 77,  58 => 76,  54 => 75,  48 => 72,  44 => 71,  39 => 70,);
    }
...
#}
<article{{ attributes }}>
  <div{{ content_attributes.addClass(\"hero-section\") }}>
    <div class=\"hero-section__body\"><div>{{ content.body }}</div>
    <div class=\"hero-banner\">
        <div class=\"hero-banner__content\">
            <div class=\"hero-banner__content-title\">{{ content.field_her }}</div>
            <div class=\"hero-banner__content-heading\">{{ content.field_hero_tittle }}</div>
            <div class=\"hero-banner__btn\"> {{ content.field_hero_button }} </div>
            <div class=\"hero-banner__social-icons\"> {{ content.field_soc }} </div>
        </div> 
        <div class=\"hero-banner__image\"> {{ content.field_hero_image }} </div>  
    </div>
    <div class=\"hero-footer__description\"> {{ content.field_hero_footer_description }}</div>
  </div>
  {{dsm(content)}}
</article>
", "themes/custom/dream_agency/templates/content/node--hero-section--teaser.html.twig", "/var/www/html/web/themes/custom/dream_agency/templates/content/node--hero-section--teaser.html.twig");
    }
