...
/* themes/custom/dream_agency/templates/fields/field--field-servi.html.twig */
class __TwigTemplate_9bf89dc356842772aa3a971d6e08f33f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            if (($context["multiple"] ?? null)) {
                // line 47
                echo "    <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "services-card"], "method", false, false, true, 47), 47, $this->source), "html", null, true);
                echo ">
      ";
                // line 48
...
";
    ...
    {
        return "themes/custom/dream_agency/templates/fields/field--field-servi.html.twig";
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass(\"services-card\") }}>
      {% for item in items %}
...
{% endif %}
", "themes/custom/dream_agency/templates/fields/field--field-servi.html.twig", "/var/www/html/web/themes/custom/dream_agency/templates/fields/field--field-servi.html.twig");
    }
