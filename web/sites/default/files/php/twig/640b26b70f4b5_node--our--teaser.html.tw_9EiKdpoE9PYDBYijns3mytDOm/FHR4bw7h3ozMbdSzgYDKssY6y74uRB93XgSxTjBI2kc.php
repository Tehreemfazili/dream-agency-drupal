...
class __TwigTemplate_1c4affdabe838625f470da76c0559304 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
#}
<article{{ attributes }}>
  <div{{ content_attributes.addClass(\"services\") }}>
    <h1>{{content.field_services}}</h1>
    <div>{{content.field_services_subtitle}}</div>
    <div>{{content.field_servi}}</div>
    <div class=\"services-footer\">
        <div class=\"services-footer__description\">{{content.field_footer_description}}</div>
        <div class=\"services-footer__link\">{{content.field_service_footer_link}}</div>
    </div>
  </div>
</article>
", "themes/custom/dream_agency/templates/content/node--our--teaser.html.twig", "/var/www/html/web/themes/custom/dream_agency/templates/content/node--our--teaser.html.twig");
    }
