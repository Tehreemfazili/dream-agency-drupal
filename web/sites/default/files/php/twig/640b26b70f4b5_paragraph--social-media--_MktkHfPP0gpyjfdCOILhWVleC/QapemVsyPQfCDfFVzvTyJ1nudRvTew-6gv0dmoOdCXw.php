...
";
  ...
  ";
        // line 60
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\devel\Twig\Extension\Debug']->message($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 60, $this->source)]));
        echo "
";
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "><img src= ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (("web/themes/custom/dream_agency/assets/svg/" . twig_lower_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["title"] ?? null), 57, $this->source))) . ".png"), "html", null, true);
        echo "></a>
    ";
    }
    ...
    {
        return array (  84 => 57,  80 => 56,  74 => 60,  71 => 59,  69 => 56,  64 => 55,  57 => 54,  53 => 52,  51 => 51,  49 => 50,  46 => 49,  44 => 46,  43 => 45,  42 => 44,  41 => 42,);
    }
...
{% block paragraph %}
  <div{{ attributes.addClass(classes) }}>
    {% block content %}
        <a href= {{ url }}><img src= {{ \"web/themes/custom/dream_agency/assets/svg/\" ~ title|lower ~ \".png\" }}></a>
    {% endblock %}
  </div>
  {{dsm(content)}}
{% endblock paragraph %}
