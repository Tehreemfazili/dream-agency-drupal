...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "><img src= ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (("/assets/svg/" . twig_lower_filter($this->env, $this->sandbox->ensureToStringAllowed(($context["title"] ?? null), 57, $this->source))) . ".png"), "html", null, true);
        echo "></a>
    ";
    }
...
{% block paragraph %}
  <div{{ attributes.addClass(classes) }}>
    {% block content %}
        <a href= {{ url }}><img src= {{ \"/assets/svg/\" ~ title|lower ~ \".png\" }}></a>
    {% endblock %}
  </div>
  {{dsm(content)}}
{% endblock paragraph %}
